...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/alg/ShortestPathSingleSource.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/alg/ShortestPathAllPairs.html)
- **S-T**: Finds the shortest path from a specified source vertex `S` to a target vertex `T` [[javadoc]](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/alg/ShortestPathST.html). There is also a variant that can utilize a user-heuristic of the distant to `T` to optimize the search.
 [[javadoc]](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/alg/ShortestPathHeuristicST.html)
- **K Shortest Paths S-T**: Finds the `k` shortest loopless paths from a specified source vertex `S` to a target vertex `T` [[javadoc]](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/alg/KShortestPathsST.html)
- **Voronoi Cells**: Computes the Voronoi cells of a set of points in a graph. The Voronoi cell of a point is the set of vertices in the graph that are closer to this point than to any other point in the set. [[javadoc]](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/alg/VoronoiAlgo.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/alg/ChinesePostman.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/alg/TspMetricMatchingAppx.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/alg/MatchingAlgo.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/alg/MaximumFlow.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/alg/MinimumCostFlow.html)

### Minimum Spanning Tree (MST)
The Minimum Spanning Tree algorithms find the spanning tree (edges subset that maintain the connectivity of the graph) with the minimum weight with respect to a given edge weight function. Both  [undirected ](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/alg/MinimumSpanningTree.html) and [directed ](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/alg/MinimumDirectedSpanningTree.html) graphs are supported.
[[javadoc]](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/alg/MinimumSpanningTree.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/alg/CoresAlgo.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/alg/MaximalCliquesEnumerator.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/alg/ColoringAlgo.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/alg/BfsIter.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/alg/DfsIter.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/alg/RandomWalkIter.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/alg/StronglyConnectedComponentsAlgo.html)
- **Weakly Connected Components**: Identifies the connected components in a directed graph as if the edges were undirected.
[[javadoc]](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/alg/WeaklyConnectedComponentsAlgo.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/alg/VertexCover.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/alg/EdgeCover.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/alg/DominatingSetAlgo.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/alg/MinimumMeanCycle.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/alg/CyclesEnumerator.html)
...
- **Offline**: The algorithm receive both the graph and the set of queries in advance, and it is require to answer these queries along. [[javadoc]](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/alg/LowestCommonAncestorOffline.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/alg/LowestCommonAncestorStatic.html)
- **Dynamic**: support efficient queries of LCA while allowing adding new leaves to the tree.
[[javadoc]](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/alg/LowestCommonAncestorDynamic.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/alg/IsomorphismTester.html)

### Other
- **Eulerian Tour**: Finds an Eulerian tour (a cycle that visits every edge exactly once) in a graph if one exists.
[[javadoc]](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/alg/EulerianTourAlgo.html)
- **Hamiltonian Path**: Finds a Hamiltonian path (a path that visits every vertex exactly once) or cycle in a graph if one exists.
[[javadoc]](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/alg/HamiltonianPathAlgo.html)
- **Topological Order Computation**: Determines a topological order of the vertices in a directed acyclic graph (DAG).
[[javadoc]](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/alg/TopologicalOrderAlgo.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/alg/TreePathMaxima.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/alg/ClosuresEnumerator.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/alg/SteinerTreeAlgo.html)

## Graphs I/O
The library supports reading and writing graphs from/to files in various formats. The supported formats are:
- **GraphML**: [GraphMlGraphReader](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/io/GraphMlGraphReader.html), [GraphMlGraphWriter](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/io/GraphMlGraphWriter.html).
- **Leda**: [LedaGraphReader](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/io/LedaGraphReader.html), [LedaGraphWriter](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/io/LedaGraphWriter.html).
- **Graph6**: [Graph6GraphReader](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/io/Graph6GraphReader.html), [Graph6GraphWriter](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/io/Graph6GraphWriter.html), [Sparse6GraphReader](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/io/Sparse6GraphReader.html), [Sparse6GraphWriter](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/io/Sparse6GraphWriter.html), [Digraph6GraphReader](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/io/Digraph6GraphReader.html), [Digraph6GraphWriter](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/io/Digraph6GraphWriter.html).
- **DIMACS**: [DimacsGraphReader](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/io/DimacsGraphReader.html), [DimacsGraphWriter](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/io/DimacsGraphWriter.html).
- **Gexf**: [GexfGraphReader](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/io/GexfGraphReader.html), [GexfGraphWriter](https://barakugav.github.io/JGAlgo/0.4.0/com/jgalgo/io/GexfGraphWriter.html).
