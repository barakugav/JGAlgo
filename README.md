...
The most basic object in the library is a [Graph](https://barakugav.github.io/JGAlgo/0.2.0/com/jgalgo/graph/Graph.html). A graph consist of vertices and edges (directed or undirected) connecting between pairs of vertices, all represented by `int` primitive IDs. Algorithms such as [shortest path algorithm](https://barakugav.github.io/JGAlgo/0.2.0/com/jgalgo/ShortestPathSingleSource.html) accept a graph as an input and perform some computation on it. Here is a snippet creating a directed graph with three vertices and edges with real values weights, and computing the shortest paths from a source vertex:
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.2.0/com/jgalgo/ShortestPathSingleSource.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.2.0/com/jgalgo/ShortestPathAllPairs.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.2.0/com/jgalgo/ShortestPathWithHeuristic.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.2.0/com/jgalgo/MatchingAlgorithm.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.2.0/com/jgalgo/MaximumFlow.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.2.0/com/jgalgo/MinimumCostFlow.html)

### Minimum Spanning Tree (MST)
The Minimum Spanning Tree algorithms find the spanning tree (edges subset that maintain the connectivity of the graph) with the minimum weight with respect to a given edge weight function. Both  [undirected ](https://barakugav.github.io/JGAlgo/0.2.0/com/jgalgo/MinimumSpanningTree.html) and [directed ](https://barakugav.github.io/JGAlgo/0.2.0/com/jgalgo/MinimumDirectedSpanningTree.html) graphs are supported.
[[javadoc]](https://barakugav.github.io/JGAlgo/0.2.0/com/jgalgo/MinimumSpanningTree.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.2.0/com/jgalgo/CoreAlgo.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.2.0/com/jgalgo/MaximalCliques.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.2.0/com/jgalgo/Coloring.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.2.0/com/jgalgo/BFSIter.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.2.0/com/jgalgo/DFSIter.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.2.0/com/jgalgo/ConnectedComponentsAlgo.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.2.0/com/jgalgo/BiConnectedComponentsAlgo.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.2.0/com/jgalgo/VertexCover.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.2.0/com/jgalgo/MinimumMeanCycle.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.2.0/com/jgalgo/CyclesFinder.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.2.0/com/jgalgo/MinimumCutST.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.2.0/com/jgalgo/MinimumCutGlobal.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.2.0/com/jgalgo/LowestCommonAncestorStatic.html)
- **Dynamic**: support efficient queries of LCA while allowing adding new leaves to the tree.
[[javadoc]](https://barakugav.github.io/JGAlgo/0.2.0/com/jgalgo/LowestCommonAncestorDynamic.html)

### Other
- **Eulerian Tour**: Finds an Eulerian tour (a cycle that visits every edge exactly once) in a graph if one exists.
[[javadoc]](https://barakugav.github.io/JGAlgo/0.2.0/com/jgalgo/EulerianTourAlgo.html)
- **Topological Order Computation**: Determines a topological order of the vertices in a directed acyclic graph (DAG).
[[javadoc]](https://barakugav.github.io/JGAlgo/0.2.0/com/jgalgo/TopologicalOrderAlgo.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.2.0/com/jgalgo/ChinesePostman.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.2.0/com/jgalgo/TSPMetricMatchingAppx.html)
...
[[javadoc]](https://barakugav.github.io/JGAlgo/0.2.0/com/jgalgo/TreePathMaxima.html)
