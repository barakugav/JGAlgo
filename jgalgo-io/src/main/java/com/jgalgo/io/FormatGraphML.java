...
class FormatGraphML implements GraphFormat {

	private FormatGraphML() {}

	static final FormatGraphML Instance = new FormatGraphML();
	...
	private static final List<String> FILE_EXTENSIONS = List.of("graphml");
