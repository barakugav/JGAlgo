...
import com.jgalgo.alg.path.ShortestPathHeuristicSt2;
import com.jgalgo.alg.path.ShortestPathSingleSource;
import com.jgalgo.alg.path.ShortestPathSt2;
...
public class ShortestPathSt2Bench {
	...
	void benchStShortestPath(Object algo, Blackhole blackhole) {
		...
		Object result;
		if (algo instanceof ShortestPathHeuristicSt2) {
			result = ((ShortestPathHeuristicSt2) algo).computeShortestPath(g, w, source, target, heuristic);
		} else if (algo instanceof ShortestPathSt2) {
			result = ((ShortestPathSt2) algo)
	...
	public static class Gnp extends ShortestPathSt2Bench {
		...
		public void BidirectionalDijkstra(Blackhole blackhole) {
			benchStShortestPath(ShortestPathSt2.builder().build(), blackhole);
		}
	...
	@Fork(value = 1, warmups = 0)
	@State(Scope.Benchmark)
	public static class BarabasiAlbert extends ShortestPathSt2Bench {
	...
	@Fork(value = 1, warmups = 0)
	@State(Scope.Benchmark)
	public static class RecursiveMatrix extends ShortestPathSt2Bench {
	...
	private static ShortestPathHeuristicSt2 getAlgo(String implName) {
		ShortestPathHeuristicSt2.Builder builder = ShortestPathHeuristicSt2.builder();
