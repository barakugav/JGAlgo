...
public interface ConnectivityAlgorithm {
	...
	/**
	 * Get a new connectivity algorithm builder.
	 * <p>
	 * This is the intended way to instantiate a new {@link ConnectivityAlgorithm}
	 * object.
	 *
	 * @return a new builder that can builder {@link ConnectivityAlgorithm} objects.
	 */
	...
	/**
	 * A builder for {@link ConnectivityAlgorithm} object.
	 *
	 * @author Barak Ugav
	 */
