...
public class BitsLookupTable {
	...
	public static class Count {
		...
		/**
		 * Construct a new lookup table for bitCount operation for integer words of some
		 * maximum size.
		 *
	...
	public static class Ith {
		...
		/**
		 * Construct a new lookup table for i-th bit operation for integer words of some
		 * maximum size.
		 *
		 * @param wordsize maximum number of bits needed to represent an integer
