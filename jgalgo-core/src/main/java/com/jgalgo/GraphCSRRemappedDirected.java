...
class GraphCSRRemappedDirected extends GraphCSRBase {
	static class Builder extends GraphCSRBase.BuilderDirected implements GraphBuilderFixedRemapped {
		@Override
		public GraphBuilderFixedRemapped.BuilderResult build() {
			...
			return new GraphBuilderFixedRemapped.BuilderResult(g, callbackData.edgesCsrToOrig, callbackData.edgesOrigToCsr);
		}
	}
