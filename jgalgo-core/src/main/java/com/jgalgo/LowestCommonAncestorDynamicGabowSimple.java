 ...
 * space. More specifically, the {@link #addLeaf(LowestCommonAncestorDynamic.Node)} operation is perform in \(O(\log^2 n)\) amortized
 * time and {@link #findLowestCommonAncestor(LowestCommonAncestorDynamic.Node, LowestCommonAncestorDynamic.Node)} is perform in constant time.
 * <p>
 * This implementation is used by the better linear LCA algorithm {@link LowestCommonAncestorDynamicGabowLinear} and rarely should be
 * used directly.
 * <p>
