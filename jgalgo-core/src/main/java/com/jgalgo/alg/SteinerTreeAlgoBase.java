...
interface SteinerTreeAlgoBase extends SteinerTreeAlgo {

	@SuppressWarnings("unchecked")
	@Override
	default <V, E> SteinerTreeAlgo.Result<V, E> computeSteinerTree(Graph<V, E> g, WeightFunction<E> w,
	...
	private static <V, E> SteinerTreeAlgo.Result<V, E> resultFromIndexResult(Graph<V, E> g,
		...
		if (g instanceof IntGraph) {
			return (SteinerTreeAlgo.Result<V, E>) new SteinerTrees.IntResultFromIndexResult((IntGraph) g, indexResult);
		} else {
			return new SteinerTrees.ObjResultFromIndexResult<>(g, indexResult);
		}
	}
