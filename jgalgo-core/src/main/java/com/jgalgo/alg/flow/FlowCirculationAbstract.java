...
abstract class FlowCirculationAbstract implements FlowCirculation {

	@SuppressWarnings("unchecked")
	@Override
	public <V, E> Flow<V, E> computeCirculation(Graph<V, E> g, WeightFunction<E> capacity, WeightFunction<V> supply) {
	...
	protected abstract IFlow computeCirculation(IndexGraph g, IWeightFunction capacity, IWeightFunction supply);
