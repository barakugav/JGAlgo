...
import com.jgalgo.alg.match.MatchingWeightedGabow1990Abstract.Worker.EdgeEvent;
...
abstract class MatchingWeightedGabow1990Abstract extends MatchingAlgoAbstractBasedMaximum {
	...
	abstract static class Worker {
		...
		private IMatching computeMaxMatching(boolean perfect) {
			...
			return new IndexMatching(gOrig, matched);
		}
