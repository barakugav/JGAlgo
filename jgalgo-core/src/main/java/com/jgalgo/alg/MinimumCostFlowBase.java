...
interface MinimumCostFlowBase extends MinimumCostFlow {

	@SuppressWarnings("unchecked")
	@Override
	default <V, E> Flow<V, E> computeMinCostMaxFlow(Graph<V, E> g, WeightFunction<E> capacity, WeightFunction<E> cost,
			V source, V sink) {
	...
	@SuppressWarnings("unchecked")
	@Override
	default <V, E> Flow<V, E> computeMinCostFlow(Graph<V, E> g, WeightFunction<E> capacity, WeightFunction<E> cost,
	...
	IFlow computeMinCostMaxFlow(IndexGraph g, IWeightFunction capacity, IWeightFunction cost, int source, int sink);
	...
	IFlow computeMinCostFlow(IndexGraph g, IWeightFunction capacity, IWeightFunction cost, IWeightFunction lowerBound,
