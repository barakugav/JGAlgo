 ...
 * implementation is provided via {@code newInstance()} method (e.g.
 ...
 * integer only (e.g. {@link com.jgalgo.alg.shortestpath.ShortestPathSingleSource.IResult}). In the common use case,
 * there is no need to use {@link com.jgalgo.graph.IntGraph} and the result objects that are specific for it.
 *
 * <p>
