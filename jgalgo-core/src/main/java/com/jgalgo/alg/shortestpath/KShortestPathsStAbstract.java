 ...
 * @author Barak Ugav
 */
public abstract class KShortestPathsStAbstract implements KShortestPathsSt {
	...
	protected abstract List<IPath> computeKShortestPaths(IndexGraph g, IWeightFunction w, int source, int target,
			int k);
