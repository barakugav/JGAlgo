 ...
 * {@link KShortestPathsSt2HershbergerMaxelSuri}), and in that case the algorithm falls back to the former method. In
 ...
 * @author Barak Ugav
 */
abstract class KShortestPathsSt2PathsTreeBased extends KShortestPathsSt2s.AbstractImpl {
