 ...
 * @author Barak Ugav
 */
public interface ShortestPathHeuristicSt2 {
	 ...
	 *
	 * <p>
	 * This is the recommended way to instantiate a new {@link ShortestPathHeuristicSt2} object. The
	 * {@link ShortestPathHeuristicSt2.Builder} might support different options to obtain different implementations.
	 *
	 * @return a default implementation of {@link ShortestPathHeuristicSt2}
	 */
	static ShortestPathHeuristicSt2 newInstance() {
	 ...
	 *
	 * @return a new builder that can build {@link ShortestPathHeuristicSt2} objects
	 */
	static ShortestPathHeuristicSt2.Builder builder() {
		return new ShortestPathHeuristicSt2.Builder() {

			private String impl;

			@Override
			public ShortestPathHeuristicSt2 build() {
				if (impl != null) {
					switch (impl) {
						case "a-star":
			...
			public void setOption(String key, Object value) {
				switch (key) {
					case "impl":
						...
						break;
					default:
						ShortestPathHeuristicSt2.Builder.super.setOption(key, value);
				}
			}
		};
	}
	...
	/**
	 * A builder for {@link ShortestPathHeuristicSt2} objects.
	 *
	 * @see    ShortestPathHeuristicSt2#builder()
	 * @author Barak Ugav
	 */
	static interface Builder extends AlgorithmBuilderBase {
		 ...
		 */
		ShortestPathHeuristicSt2 build();
	}
