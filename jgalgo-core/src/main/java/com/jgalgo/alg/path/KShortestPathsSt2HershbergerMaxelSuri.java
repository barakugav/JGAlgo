 ...
 * n))\). Unlike the undirected case, see {@link KShortestPathsSt2KatohIbarakiMine}, in directed graphs the fast
 ...
 * @author Barak Ugav
 */
class KShortestPathsSt2HershbergerMaxelSuri extends KShortestPathsSt2PathsTreeBased {
	...
	@Override
	KShortestPathsSt2PathsTreeBased.ShortestPathSubroutine newShortestPathSubroutine(IndexGraph g, IWeightFunction w,
	...
	private class ShortestPathSubroutine extends KShortestPathsSt2PathsTreeBased.ShortestPathSubroutine {
