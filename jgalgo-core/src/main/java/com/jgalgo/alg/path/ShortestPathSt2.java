 ...
 *
 * <p>
 * A variant with a heuristic distance function is also available, see {@link ShortestPathHeuristicSt2}.
 *
 * <p>
 ...
 * @see    ShortestPathHeuristicSt2
 * @author Barak Ugav
 */
public interface ShortestPathSt2 {
	 ...
	 *
	 * <p>
	 * This is the recommended way to instantiate a new {@link ShortestPathSt2} object. The
	 * {@link ShortestPathSt2.Builder} might support different options to obtain different implementations.
	 *
	 * @return a default implementation of {@link ShortestPathSt2}
	 */
	static ShortestPathSt2 newInstance() {
	 ...
	 *
	 * @return a new builder that can build {@link ShortestPathSt2} objects
	 */
	static ShortestPathSt2.Builder builder() {
		return () -> {
			return new ShortestPathSt2() {
				ShortestPathSt2 cardinalityStSp = new ShortestPathSt2BidirectionalBfs();
				ShortestPathSt2 weightedStSp = new ShortestPathSt2BidirectionalDijkstra();
	...
	/**
	 * A builder for {@link ShortestPathSt2} objects.
	 *
	 * @see    ShortestPathSt2#builder()
	 * @author Barak Ugav
	 */
