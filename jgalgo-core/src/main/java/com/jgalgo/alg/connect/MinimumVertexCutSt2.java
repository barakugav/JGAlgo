 ...
 * @author Barak Ugav
 */
public interface MinimumVertexCutSt2 {
	 ...
	 *
	 * <p>
	 * This is the recommended way to instantiate a new {@link MinimumVertexCutSt2} object.
	 *
	 * @return a default implementation of {@link MinimumVertexCutSt2}
	 */
	static MinimumVertexCutSt2 newInstance() {
		return new MinimumVertexCutSt2EdgeCut();
	}
