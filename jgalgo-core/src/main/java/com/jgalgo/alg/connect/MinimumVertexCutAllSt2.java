 ...
 * {@code source (S)} and {@code sink (T)}. For a single minimum vertex-cut, use {@link MinimumVertexCutSt2}. For the
 ...
 * @author Barak Ugav
 */
public interface MinimumVertexCutAllSt2 {
	 ...
	 *
	 * <p>
	 * This is the recommended way to instantiate a new {@link MinimumVertexCutAllSt2} object.
	 *
	 * @return a default implementation of {@link MinimumVertexCutAllSt2}
	 */
	static MinimumVertexCutAllSt2 newInstance() {
		return new MinimumVertexCutAllSt2EdgeCut();
	}
