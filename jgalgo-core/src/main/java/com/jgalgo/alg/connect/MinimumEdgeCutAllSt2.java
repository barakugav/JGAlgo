 ...
 * {@code source (S)} and {@code sink (T)}. For a single minimum edge-cut, use {@link MinimumEdgeCutSt2}. For the global
 ...
 * @author Barak Ugav
 */
public interface MinimumEdgeCutAllSt2 {
	 ...
	 *
	 * <p>
	 * This is the recommended way to instantiate a new {@link MinimumEdgeCutAllSt2} object.
	 *
	 * @return a default implementation of {@link MinimumEdgeCutAllSt2}
	 */
	static MinimumEdgeCutAllSt2 newInstance() {
		return new MinimumEdgeCutAllSt2PicardQueyranne();
	}
