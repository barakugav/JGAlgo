 ...
 * {@link MinimumEdgeCutAllSt2}. For the global variant (without terminal vertices), see {@link MinimumEdgeCutGlobal}.
 *
 * <p>
 ...
 * @author Barak Ugav
 */
public interface MinimumEdgeCutSt2 {
	 ...
	 *
	 * <p>
	 * This is the recommended way to instantiate a new {@link MinimumEdgeCutSt2} object.
	 *
	 * @return a default implementation of {@link MinimumEdgeCutSt2}
	 */
	static MinimumEdgeCutSt2 newInstance() {
		MaximumFlow maxFlowAlg = MaximumFlow.newInstance();
		if (maxFlowAlg instanceof MinimumEdgeCutSt2) {
			return (MinimumEdgeCutSt2) maxFlowAlg;
		} else {
	 ...
	 */
	static MinimumEdgeCutSt2 newFromMaximumFlow(MaximumFlow maxFlowAlg) {
