 ...
 * the auxiliary graph is computed using the {@link MinimumEdgeCutAllSt2} algorithm. The minimum vertex-cuts in the
 * original graph is the set of vertices corresponding to the edges in the minimum edge-cuts in the auxiliary graph.
 *
 * @author Barak Ugav
 */
public class MinimumVertexCutAllSt2EdgeCut extends MinimumVertexCutAllSt2Abstract {

	private final MinimumEdgeCutAllSt2 minEdgeCutAlgo = MinimumEdgeCutAllSt2.newInstance();

	/**
	 * Create a new instance of the algorithm.
	 *
	 * <p>
	 * Please prefer using {@link MinimumVertexCutAllSt2#newInstance()} to get a default implementation for the
	 * {@link MinimumVertexCutAllSt2} interface.
	 */
	public MinimumVertexCutAllSt2EdgeCut() {}
