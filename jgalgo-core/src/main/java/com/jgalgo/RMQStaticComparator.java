...
/**
 * Comparator used to compare elements in a sequence by {@link RMQStatic}
 * algorithms.
 * <p>
 * When an {@link RMQStatic} perform a preprocessing, the sequence itself of
 * elements is not passed to it, rather a comparator that can compare two
 * elements by their indices. The comparator must remain valid as long as
 * queries are still issued to the RMQ implementation.
 *
 * @author Barak Ugav
 */
@FunctionalInterface
public interface RMQStaticComparator {
	 ...
	 * @param arr an array
	 * @return an RMQ comparator that will compare elements in the array using their
	 ...
	 * @param <E> the array type
	 * @param arr an array
	 * @param c   the comparator that will be used to compare elements in the array.
	 *            If {@code null}, the {@linkplain Comparable natural ordering} of
	 *            the elements will be used.
	 * @return an RMQ comparator that will compare elements in the array using the
	 *         given comparator
	 */
	 ...
	 *
	 * @param arr an array
	 * @return an RMQ comparator that will compare elements in the array using
	 *         {@code Integer.compare()}.
	 */
