 ...
 * The {@link com.jgalgo.graph.Graph} object represent a graph, in which vertices and edges have {@code int}
 * identifiers. Vertices can be added or removed to/from a graph, and edges can be added or removed between vertices.
 * The {@link com.jgalgo.graph.Graph} object also provides methods to query the graph, such as the number of vertices
 ...
 * {@link com.jgalgo.graph.Graph#addVerticesWeights(String, Class)} or
 * {@link com.jgalgo.graph.Graph#addEdgesWeights(String, Class)} methods, a {@link com.jgalgo.graph.Weights} object is
 ...
 * implementation uses an index graph internally, and expose it via the {@link com.jgalgo.graph.Graph#indexGraph()}
