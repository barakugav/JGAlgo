 ...
 * documentation to describe both of them. If the mapping was obtained by {@link Graph#indexGraphVerticesMap()} it will
 * map between vertices IDs and indices, and if it was obtained by {@link Graph#indexGraphEdgesMap()} it will map
 * between edges IDs and indices.
 *
 * @see    IndexGraph
 * @author Barak Ugav
 */
