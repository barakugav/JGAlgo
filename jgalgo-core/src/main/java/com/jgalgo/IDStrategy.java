...
public abstract class IDStrategy {
	...
	/**
	 * Add a listener that will be notified each time the strategy add or remove an
	 * id.
	 *
	 * @param listener a listener object that will be called when the strategy add
	 *                 or remove an id
	 */
	...
	/**
	 * A listener that will be notified each time a strategy chooses to swap two
	 * IDs.
	 * <p>
	 * The strategy implementation might swap IDs to maintain its invariants. These
	 * swaps can be subscribed using this
	 * {@link IDStrategy#addIDSwapListener(IDSwapListener)}, and the listener will
	 * be called when a swap occur.
	 *
	 * @author Barak Ugav
	 */
	@FunctionalInterface
