...
import com.jgalgo.internal.data.DynamicTreeSplayExtension.SplayNodeExtended;
...
class DynamicTreeSplayExtended extends DynamicTreeSplay {
	...
	private DynamicTreeSplayExtended(double weightLimit, DynamicTreeSplayExtension[] extensions) {
	...
	private static class Node extends DynamicTreeSplay.SplayNode implements SplayNodeExtended {
		int idx;
	...
	static class SplayImplWithExtensions extends DynamicTreeSplay.SplayImplWithRelativeWeights {
