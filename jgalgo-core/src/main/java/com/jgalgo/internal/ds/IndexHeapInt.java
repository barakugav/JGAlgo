...
/**
 * A heap of indices in pre specified range with {@code int} keys.
 *
 * <p>
 ...
 * terms of memory and cache locality. This heap use {@code int} keys with the default comparator to compare different
 * elements (indices). Other than that, this heap is very similar to {@link IntIntReferenceableHeap}.
 *
 * @author Barak Ugav
 */
public interface IndexHeapInt extends IndexHeapBase {
	...
	/**
	 * Creates a new instance of {@link IndexHeapInt}.
	 *
	 * @param  size the size of the heap
	 * @return      a new instance of {@link IndexHeapInt}
	 */
	static IndexHeapInt newInstance(int size) {
		return new IndexPairingHeapInt(size);
	}
