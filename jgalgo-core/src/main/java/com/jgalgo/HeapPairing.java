 ...
 * {@link #removeRef(HeapReference)} and {@link #decreaseKey(HeapReference, Object)} which takes \(O(\log n)\) time
 * amortized.
 * <p>
...
public class HeapPairing<E> extends HeapReferenceableAbstract<E> {
	...
	/**
	 * Constructs a new, empty Pairing heap, sorted according to the natural ordering of its elements.
	 * <p>
	...
	/**
	 * Constructs a new, empty Pairing heap, sorted according to the specified comparator.
	 * <p>
