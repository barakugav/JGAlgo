	...
	public void testVerticesWeights() {
		for (boolean directed : BooleanList.of(false, true)) {
			...
			for (boolean index : BooleanList.of(false, true)) {
				...
				assertThrows(UnsupportedOperationException.class, () -> gUnmod.addVerticesWeights("key", null));
			}
		}
	}
	...
	public void testEdgesWeights() {
		for (boolean directed : BooleanList.of(false, true)) {
			...
			for (boolean index : BooleanList.of(false, true)) {
				...
				assertThrows(UnsupportedOperationException.class, () -> gUnmod.addEdgesWeights("key", null));
			}
		}
	}
