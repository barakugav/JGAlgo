...
public class MinimumVertexCutAllSt2EdgeCutTest extends TestBase {

	@Test
	public void testRandGraphDirectedUnweighted() {
		final long seed = 0x5f14bcbfd8d18cc2L;
		testRandGraphs(new MinimumVertexCutAllSt2EdgeCut(), true, false, seed);
	}

	@Test
	public void testRandGraphUndirectedUnweighted() {
		final long seed = 0x581f01ef9a0f8a50L;
		testRandGraphs(new MinimumVertexCutAllSt2EdgeCut(), false, false, seed);
	}

	@Test
	public void testRandGraphDirectedWeighted() {
		final long seed = 0xc9c1095bcfd2ba56L;
		testRandGraphs(new MinimumVertexCutAllSt2EdgeCut(), true, true, seed);
	}

	@Test
	public void testRandGraphUndirectedWeighted() {
		final long seed = 0xabe3d570c4698993L;
		testRandGraphs(new MinimumVertexCutAllSt2EdgeCut(), false, true, seed);
	}

	static void testRandGraphs(MinimumVertexCutAllSt2 algo, boolean directed, boolean weighted, long seed) {
	...
	public void testBuilderDefaultImpl() {
		MinimumVertexCutAllSt2 alg = MinimumVertexCutAllSt2.newInstance();
		assertEquals(MinimumVertexCutAllSt2EdgeCut.class, alg.getClass());
	}
