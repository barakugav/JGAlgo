...
public class MinimumEdgeCutAllSt2PicardQueyranneTest extends TestBase {

	@Test
	public void directed() {
		final long seed = 0xc787bb5a521199f5L;
		testMinCuts(new MinimumEdgeCutAllSt2PicardQueyranne(), true, seed);
	}

	@Test
	public void undirected() {
		final long seed = 0x491c179eb3311751L;
		testMinCuts(new MinimumEdgeCutAllSt2PicardQueyranne(), false, seed);
	}

	private static void testMinCuts(MinimumEdgeCutAllSt2 algo, boolean directed, long seed) {
	...
	public void testBuilderDefaultImpl() {
		MinimumEdgeCutAllSt2 algo = MinimumEdgeCutAllSt2.newInstance();
		assertEquals(MinimumEdgeCutAllSt2PicardQueyranne.class, algo.getClass());
	}
