...
public class MinimumEdgeCutStTestUtils extends TestUtils {

	public static void testRandGraphs(MinimumEdgeCutSt algo, long seed, boolean directed) {
	...
	public static void testRandGraphsInt(MinimumEdgeCutSt algo, long seed, boolean directed) {
		final SeedGenerator seedGen = new SeedGenerator(seed);
		Random rand = new Random(seedGen.nextSeed());
		PhasedTester tester = new PhasedTester();
		tester.addPhase().withArgs(6, 6).repeat(32);
	...
	public static void testRandGraphsMultiSourceMultiSink(MinimumEdgeCutSt algo, long seed, boolean directed) {
		final SeedGenerator seedGen = new SeedGenerator(seed);
		Random rand = new Random(seedGen.nextSeed());
		PhasedTester tester = new PhasedTester();
		tester.addPhase().withArgs(6, 6).repeat(32);
	...
	public static void testRandGraphsMultiSourceMultiSinkInt(MinimumEdgeCutSt algo, long seed, boolean directed) {
		final SeedGenerator seedGen = new SeedGenerator(seed);
		Random rand = new Random(seedGen.nextSeed());
		PhasedTester tester = new PhasedTester();
		tester.addPhase().withArgs(6, 6).repeat(32);
