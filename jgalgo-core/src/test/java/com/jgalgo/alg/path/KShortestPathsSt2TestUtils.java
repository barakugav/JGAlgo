...
class KShortestPathsSt2TestUtils extends TestBase {

	static void randGraphs(KShortestPathsSt2 algo, boolean directed, long seed) {
	...
	static void randGraph(KShortestPathsSt2 algo, boolean directed, int n, int m, int k, long seed) {
	...
	static void invalidArgsTest(KShortestPathsSt2 algo, boolean directed) {
	...
	public void testDefaultImpl() {
		KShortestPathsSt2 algo = KShortestPathsSt2.newInstance();
	...
	public void testSetOption() {
		...
		assertEquals(KShortestPathsSt2Yen.class, builder.build().getClass());
		builder.setOption("impl", "katoh-ibaraki-mine");
		assertEquals(KShortestPathsSt2KatohIbarakiMine.class, builder.build().getClass());
		builder.setOption("impl", "hershberger-maxel-suri");
		assertEquals(KShortestPathsSt2HershbergerMaxelSuri.class, builder.build().getClass());
