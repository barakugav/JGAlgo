...
public class ShortestPathSt2BidirectionalDijkstraTest extends TestBase {

	private static ShortestPathSingleSource sssp() {
		return ShortestPathSt2TestUtils.ssspFromSpst(new ShortestPathSt2BidirectionalDijkstra());
	}
	...
	public void simpleSmallGraph() {
		...
		ShortestPathSt2 algo = new ShortestPathSt2BidirectionalDijkstra();
