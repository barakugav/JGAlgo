...
public class KShortestPathsSt2KatohIbarakiMineTest extends TestBase {
	...
	public void randGraphs() {
		...
		KShortestPathsSt2TestUtils.randGraphs(builder.build(), false, 0x3b8b75d281206314L);
	}
	...
	public void randGraphWithDefaultFastReplacementAlgoThreshold() {
		KShortestPathsSt2.Builder builder = KShortestPathsSt2.builder();
		builder.setOption("impl", "katoh-ibaraki-mine");
		KShortestPathsSt2TestUtils.randGraph(builder.build(), false, 1000, 3000, 10, 0xc9c5279d5fd2e4acL);
	}

	@Test
	public void invalidArgsTest() {
		KShortestPathsSt2TestUtils.invalidArgsTest(new KShortestPathsSt2KatohIbarakiMine(), false);

		KShortestPathsSt2 algo = new KShortestPathsSt2KatohIbarakiMine();
