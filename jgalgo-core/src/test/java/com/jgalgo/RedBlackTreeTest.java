...
public class RedBlackTreeTest extends TestBase {
	...
	public void testExtractMax() {
		...
		BinarySearchTreeTestUtils.testExtractMax(RedBlackTree::new, seed);
	}
	...
	public void testFindSmallersDefaultCompare() {
		...
		BinarySearchTreeTestUtils.testFindSmallersDefaultCompare(RedBlackTree::new, seed);
	}

	@Test
	public void testFindSmallersCustomCompare() {
		final long seed = 0x73810ca9d38884ecL;
		BinarySearchTreeTestUtils.testFindSmallersCustomCompare(RedBlackTree::new, seed);
	}

	@Test
	public void testFindGreatersDefaultCompare() {
		final long seed = 0xec49fe38ca3ca19bL;
		BinarySearchTreeTestUtils.testFindGreatersDefaultCompare(RedBlackTree::new, seed);
	}

	@Test
	public void testFindGreatersCustomCompare() {
		final long seed = 0x5939e3cdc2c3fb8fL;
		BinarySearchTreeTestUtils.testFindGreatersCustomCompare(RedBlackTree::new, seed);
	}

	@Test
	public void testGetPredecessorDefaultCompare() {
		final long seed = 0x941838c5890fae32L;
		BinarySearchTreeTestUtils.testGetPredecessorsDefaultCompare(RedBlackTree::new, seed);
	}

	@Test
	public void testGetPredecessorCustomCompare() {
		final long seed = 0x6eec0c5157093ce4L;
		BinarySearchTreeTestUtils.testGetPredecessorsCustomCompare(RedBlackTree::new, seed);
	}

	@Test
	public void testGetSuccessorDefaultCompare() {
		final long seed = 0xc68b22dd9e9afed9L;
		BinarySearchTreeTestUtils.testGetSuccessorsDefaultCompare(RedBlackTree::new, seed);
	}

	@Test
	public void testGetSuccessorCustomCompare() {
		final long seed = 0x89f85333bcca14e0L;
		BinarySearchTreeTestUtils.testGetSuccessorsCustomCompare(RedBlackTree::new, seed);
	}
